...
## Operações básicas, variáveis e tipos de dados
...
Vimos que as matrizes são objetos bidimensionais constituídos por linhas e colunas. 
Seus elementos assim como os vetores podem ser de apenas de um tipo, ou seja, matrizes no `R` podem ser constituídas unicamente por caracteres, números ou valores lógicos.

Ao contrário de uma matriz, um **Data Frame** não precisa ter o mesmo tipo de dados para cada elemento. 
Um Data Frame é uma lista de vetores em que cada vetor deve conter o mesmo tipo de dados, mas os diferentes vetores podem armazenar dados de diferentes tipos.
...
Algumas outras funções fornecem informações pontuais sobre o Data Frame como as funções:
- `ncol()` - número de colunas,
- `nrow()` - número de linhas,
- `dim()` - dimensão (nº de linhas e colunas)
...
A manipulação de data frames é similar à manipulação de matrizes. 
A seleção de elementos segue a mesma lógica. 
Vamos selecionar a terceira linha da segunda coluna do nosso data frame `df`.
...
Observação: espaço vazio dentro do colchetes diz para o R selecionar todas as colunas. 
O mesmo se aplica se o espaço das linhas for deixado em branco `dados[ ,colunas]`.
...
A lista é uma estrutura de dados versátil podendo conter elementos de diferentes tipos e de tamanhos diferentes. 
A principal função para as listas é servir como um **container** para armazenar qualquer número de itens de qualquer tipo.
